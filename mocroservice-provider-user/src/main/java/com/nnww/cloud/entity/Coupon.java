...
public class Coupon
{
    ...
    public Coupon(Double amountTotal, Double amountCoupon, Integer businessId, Integer scene)
    {
        super();
...
//    }
    ...
    public Coupon(Integer couponId, Double amountTotal, Double amountCoupon, Integer limitCount,
...
//        this.saleAmount = saleAmount;
    ...
    public Coupon(String images, Double originalPrice, Double amountTotal, Double amountCoupon, Integer businessId, Integer scene,
    ...
    public Coupon(Integer couponType, Integer couponId, Integer businessId, Integer isEnable, Integer deleted, Integer modified) {
        this.couponType = couponType;
        this.couponId = couponId;
        this.businessId = businessId;
        this.isEnable = isEnable;
    ...
    public Coupon(Integer couponId, Double saleAmount, String images, String activityDes, String description, String title, Integer isEnable) {
        this.couponId = couponId;
//        this.originalPrice = originalPrice;
        this.saleAmount = saleAmount;
        this.images = images;
